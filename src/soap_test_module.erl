...
from_client(Module, Options) ->
    lager:debug("_64:~n\t~p~n\t~p",[Module,Options]),
...
make_function(Module, #op{name = Name, in_type = In}, Model, Headers, Options) ->
    ...
    lager:debug("_113:~n\t~p~n\t~p",[In,Model]),
